        ...
        <a-row :gutter="24">
          <a-col :lg="8">
            <a-form-item label="编码" name="code">
              <a-input placeholder="请输入编码" v-model:value="queryParam.code"></a-input>
            </a-form-item>
          </a-col>
          <a-col :lg="8">
          ...
          <template v-if="toggleSearchStatus">
            <a-col :lg="8">
              <a-form-item label="中文名称" name="chName">
                <a-input placeholder="请输入中文名称" v-model:value="queryParam.chName"></a-input>
              </a-form-item>
            </a-col>
          </template>
...
<script lang="ts" name="basicData-chUniversity" setup>
  ...
  import { columns } from './ChUniversity.data';
